...
// Code generated by stanc v2.37.0-rc2-20-g216cb27
...
static constexpr std::array<const char*, 32> locations_array__ =
  ...
  " (in 'PQ', line 3, column 8 to column 16)",
  " (in 'PQ', line 3, column 2 to column 41)",
  " (in 'PQ', line 4, column 8 to column 16)",
  " (in 'PQ', line 4, column 2 to column 41)",
  " (in 'PQ', line 5, column 8 to column 16)",
  " (in 'PQ', line 5, column 2 to column 36)",
...
public:
  ...
  inline std::vector<std::string> model_compile_info() const noexcept {
    return std::vector<std::string>{"stanc_version = stanc3 v2.37.0-rc2-20-g216cb27",
    ...
    try {
      ...
      auto p_neg =
        in__.template read_constrain_simplex<
          Eigen::Matrix<local_scalar_t__,-1,1>, jacobian__>(lp__, n_bucket);
